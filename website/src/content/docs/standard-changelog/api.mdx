...
Generating per-package release notes in a monorepo — the pattern used by release tooling such as [simple-release](https://github.com/TrigenSoftware/simple-release):
