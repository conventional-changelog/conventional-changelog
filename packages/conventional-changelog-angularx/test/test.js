...
betterThanBefore.setups([
  function () {
    ...
    gitDummyCommit('dependencies: deps updated')
  ...
  it('should work if there is no semver tag', function (done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function (chunk) {
        ...
        expect(chunk).to.include('Dependency update')
        expect(chunk).to.include('deps updated')
        ...
        expect(chunk).to.not.include('dependencies')
