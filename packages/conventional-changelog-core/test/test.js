...
betterThanBefore.setups([
  ...
  function () { // 19
    ...
    exec('git tag v4.0.0')
    exec('git merge feature -m"Merge branch \'feature\'"')
    fs.writeFileSync('./package.json', '{"version": "5.0.0"}') // required by angular preset.
