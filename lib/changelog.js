...
function getGitLogCommand(grep, format, from, to) {
  ...
  console.log( util.format(cmd, grep, format, from, to) );
...
module.exports = function generate(options, callback) {
  ...
  options.version = options.version || 'NOVERSION';
  ...
  function makeLog() {
    readGitLog('^fix|^feat|BREAKING', options.from, options.to, function(commits) {
